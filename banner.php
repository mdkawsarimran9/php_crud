            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                            <h1 class="mt-4 text-center">Banner</h1>
                        ...
                        <div class="row justify-content-center my-5">
                            <div class="col-lg-6">
                                <form action="insert.php" method="post">
                                    ...
                                    <div class="mb-3">
                                        <label for="b_desc" class="form-label">Description</label>
                                        <textarea class="form-control" id="b_desc" name="b_desc"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="b_icon" class="form-label">Icon</label>
                                        <input type="text" class="form-control" id="b_icon" name="b_icon">
                                    </div>
                                    
                                    <button type="submit" class="btn btn-primary" name="b_submit">Submit</button>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        if($show = $select_query -> fetch_assoc()) {
                                                echo 
                                                "
                                                <tr>
                                                <td>".$show['title']."</td>
                                                ...
                                                <td>".$show['icon']."</td>
                                                <td>
                                                <a href='banner_update.php?id=".$show['id']."' class='btn btn-primary'>Edit</a>
                                                </td>
                                                </tr>
                                                ";
                                        } else {
